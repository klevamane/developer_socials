...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = Developer
        fields = ('email', 'date_of_birth', 'firstname', 'lastname', 'mobile')
...
class DeveloperAdmin(BaseUserAdmin):
    """This class enables the developer model to to displayed in the admin panel"""
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'date_of_birth', 'password1', 'password2', 'firstname', 'lastname', 'mobile')}
         ),
    )
